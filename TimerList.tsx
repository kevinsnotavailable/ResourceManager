    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {timers.map((timer) => (
        ...
        >
          ...
          <div className="text-3xl font-mono text-center my-4 text-gray-800 dark:text-gray-200">
          ...
          <div className="flex justify-between mt-4">
            ...
            <button
              ...
              className="p-2 rounded-full bg-blue-100 text-blue-600 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400"
            >
              <RotateCcw size={20} />
            </button>
            ...
            <button
              ...
              className="p-2 rounded-full bg-red-100 text-red-600 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400"
            >
              <Trash2 size={20} />
            </button>
          </div>
